...
from PyQt5.QtCore import QLineF, QRectF, QRect, Qt
from PyQt5.QtGui import QColor, QBrush, QPen, QPainterPath, QPainter, QFont
from PyQt5.QtWidgets import QGraphicsItem, QStyleOptionGraphicsItem, QWidget, QStyle
...
class Chip(QGraphicsItem):
    ...
    def mousePressEvent(self, event: PyQt5.QtWidgets.QGraphicsSceneMouseEvent):
        super().mousePressEvent(event)
        self.update()

    def mouseMoveEvent(self, event: PyQt5.QtWidgets.QGraphicsSceneMouseEvent):
    ...
    def mouseReleaseEvent(self, event: PyQt5.QtWidgets.QGraphicsSceneMouseEvent):
