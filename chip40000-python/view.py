from PyQt5.QtCore import Qt, QSize, QRectF, pyqtSlot as Slot
from PyQt5.QtGui import QWheelEvent, QIcon, QTransform, QPainter
from PyQt5.QtWidgets import (QGraphicsView, QFrame, QWidget, QStyle,
